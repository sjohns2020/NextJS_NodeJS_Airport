...
const SearchBox = ({ handleSearch }) => {
  ...
  return (
    <form
      ...
      className="flex w-full max-w-md mx-auto items-center border rounded-lg overflow-hidden mt-4"
    >
      <input
        id="search"
        type="text"
      ...
      <button
        type="submit"
        data-tab="sortFlights"
        className="bg-blue-500 text-white py-2 px-6 focus:outline-none hover:bg-blue-600 rounded-r-lg"
      >
        Search
      </button>
    </form>
